...
class AdminPanel:
    ...
    def get_dashboard_summary(self) -> dict[str, Any]:
        ...
        summary["attachments_count"] = self.db.attachment_count()
        summary["specialist_calls"] = self.db.specialist_call_count()
        return summary
    ...
    def get_recent_requests(self, limit: int = 20) -> list[dict[str, Any]]:
        return self.db.recent_requests(limit)

    def get_open_escalations(self) -> list[dict[str, Any]]:
        """Активные обращения, ожидающие специалиста."""
